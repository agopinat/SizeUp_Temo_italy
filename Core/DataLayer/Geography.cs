...
namespace Core.DataLayer
{
    public class Geography
    {
        ...
        public static IQueryable<Models.ZoomExtent> ZoomExtent(SizeUpContext context, long width)
        {
            ...
            {
                Key = i.GeographicLocationId.Value,
                Value = (int)Math.Round(SqlFunctions.Log(width * 360 / (i.East - i.West) / GLOBE_WIDTH).Value / ln2) - 1
            }).AsQueryable();
            var data = place
                .GroupJoin(geos, o => o.CountyId, i => i.Key, (i, o) => new { place = i, county = o.FirstOrDefault() })
                ...
                .GroupJoin(geos, o => o.place.StateId, i => i.Key, (i, o) => new { place = i.place, county = i.county,  state = o.FirstOrDefault() })
