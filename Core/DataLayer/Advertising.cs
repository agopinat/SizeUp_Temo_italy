...
namespace Core.DataLayer
{
    public class Advertising 
    {
        ...
        //public static IQueryable<Models.Advertising> Get_with_demographics(SizeUpContext context, long industryId, long geographicLocationId, AdvertisingFilters filters)
        //{
        ...
        {
            var data = Get(context, industryId, geographicLocationId, filters);
            if (data == null) return new List<Band<double>>();
